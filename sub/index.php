...
// Define the base URL where you want to send the request
$baseUrl = "https://sub.vnext.uno";

// Construct the new URL
$newURL = $baseUrl . $_SERVER['REQUEST_URI'] . '/info';

// Send a GET request to the new URL and capture the response
$response = file_get_contents($newURL);

// Optionally, you can also echo the response from the new URL
if ($response !== false) {
